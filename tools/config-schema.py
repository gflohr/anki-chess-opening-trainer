	...
	'properties': {
		...
		'board': {
			...
			'properties': {
				...
				'displayClock': {
					'description': 'Let a clock run while you are finding the answer(s)',
					'type': 'boolean',
					'default': True,
				},
			},
		...
		'studying': {
			...
			'properties': {
				'showNumberOfAnswers': {
					'description': 'Show an empty move entry for each expected move.',
					'type': 'boolean',
					'default': True,
				},
				'autoTurnCard': {
					'description': 'Automatically turn the card, when all moves have been entered.',
					'type': 'boolean',
					'default': True,
				},
			},
